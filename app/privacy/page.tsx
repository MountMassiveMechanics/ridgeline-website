export default function PrivacyPolicy() {
  return (
    <main style={{ maxWidth: 760, margin: '0 auto', padding: '48px 24px', fontFamily: 'sans-serif', color: '#111' }}>
      ...
      <p>By providing your phone number and entering into a service agreement with Ridgeline Fleet Services, you consent to receive transactional SMS messages related to your fleet service. Message frequency varies based on service activity. Message and data rates may apply. Reply STOP to opt out at any time. Reply HELP for assistance.</p>
